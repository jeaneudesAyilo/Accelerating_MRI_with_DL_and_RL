...
SPIRIT_BLOCK=(1 5 10)
KERNEL=([5,5] [7,7])
STD_NOISE=(0.0175 0.03 0.05)
LR_MASK=(1e-1 1e-2 1e-3 1e-4)
...
echo "#############################" 
echo "mask_dim : $mask_dim  acc : $acc bloc : $bloc  kernel : $kernel std_noise : $std_noise lr_mask : $lr_mask lr_other : $lr_other"
