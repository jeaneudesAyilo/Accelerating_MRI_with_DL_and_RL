...
do
    ...
    export line
    export new_config
    python ./modify_dico_general_out_of_memory.py  
...
#done < /data1/home/jean-eudes.ayilo/Pytorch-MRI-ML-recon-V1.1/mnist_experiment/mask_general_learned_normalize_code_new/result/out_of_memory.csv
done < ../mask_general_learned_normalize_code_new/result/out_of_memory.csv
